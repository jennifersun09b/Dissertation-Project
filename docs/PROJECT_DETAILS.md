...
![Innovation](figures/innovation.svg)
...
![Project structure](figures/project_structure.svg)
...
![Risk calculation](figures/risk_calculation.svg)
...
are in [`docs/WORKFLOW.md`](WORKFLOW.md).
